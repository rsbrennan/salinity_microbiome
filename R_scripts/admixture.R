...
dat2 <- read.table("~/shm/results/all.2.Q")
dat3 <- read.table("~/shm/results/all.3.Q")
dat4 <- read.table("~/shm/results/all.4.Q")
...
#colnames(dat2)<- c("species", "Individual", "P1", "P2")
#colnames(dat3)<- c("species", "Individual", "P1", "P2", "P3")
#colnames(dat4)<- c("species", "Individual", "P1", "P2", "P4")
...
write.table(dat2, "~/shm/results/all_k2.txt", quote=FALSE, col.names=TRUE,row.names=FALSE, sep="\t")
write.table(dat3, "~/shm/results/all_k3.txt", quote=FALSE, col.names=TRUE,row.names=FALSE, sep="\t")
write.table(dat4, "~/shm/results/all_k4.txt", quote=FALSE, col.names=TRUE,row.names=FALSE, sep="\t")

png("~/shm/figures/admixture.all.png", width=1000, height= 700, units="px")
...
dat2 <- read.table("~/shm/results/fh.2.Q")
dat3 <- read.table("~/shm/results/fh.3.Q")
dat4 <- read.table("~/shm/results/fh.4.Q")
...
#write txt files
write.table(dat2, "~/shm/results/fh.all_k2.txt", quote=FALSE, col.names=TRUE,row.names=FALSE, sep="\t")
write.table(dat3, "~/shm/results/fh.all_k3.txt", quote=FALSE, col.names=TRUE,row.names=FALSE, sep="\t")
write.table(dat4, "~/shm/results/fh.all_k4.txt", quote=FALSE, col.names=TRUE,row.names=FALSE, sep="\t")

png("~/shm/figures/admixture.fh.png", width=900, height= 600, units="px")
